...
class EditImovelConfirmPage extends StatefulWidget {
  @override
  _EditImovelConfirmPageState createState() => _EditImovelConfirmPageState();
}

class _EditImovelConfirmPageState extends State<EditImovelConfirmPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Edição Imóvel - Confirmação')),
      body: ListView(
        children: [
          Container(
