...
import 'edit_imovel_confirm_page.dart';

class EditImovelStepFourPage extends StatefulWidget {
  @override
  _EditImovelStepFourPageState createState() => _EditImovelStepFourPageState();
}

class _EditImovelStepFourPageState extends State<EditImovelStepFourPage> {
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EditImovelConfirmPage()),
                  );
                },
                child: Text('Avançar'),
              ),
