...
class ListaAvaliacaoUserPage extends StatelessWidget {
  ...
  static List<AvaliacaoUser> _loadAvaliacoesUser() {
    ...
    AvaliacaoUser avaliacao = AvaliacaoUser(
        'assets/images/user/img_roana.jpg', 'Roana Robredo', 4, '22/10/2021');
    list.add(avaliacao);

    avaliacao = AvaliacaoUser('assets/images/user/img_claudinha.jpg',
        'Claudida Ximenes', 3, '15/07/2021');
    list.add(avaliacao);

    avaliacao = AvaliacaoUser('assets/images/user/img_veronica.jpg',
        'Veronica Duraes', 3, '06/08/2021');
    list.add(avaliacao);
