        ...
        children: [
          Container(
              ...
              child: ClipRRect(
               ...
               Column(
                 children: [
                   Text('Veronica Duraes', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 25)),
                   ...
                   SizedBox(height: 5),
                   Text('Ele é um corretor muito competente ', style: TextStyle(fontStyle: FontStyle.italic, fontSize: 20)),
                   SizedBox(height: 20,),
                   Center(
